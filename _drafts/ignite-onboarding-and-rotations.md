...
I would then reach out to the potential mentor and see if they were interested. I would explain the generalist mentor role and the rough expectations, and offer to set up an introduction with the mentee so the two could meet and see if it would be a good fit.
